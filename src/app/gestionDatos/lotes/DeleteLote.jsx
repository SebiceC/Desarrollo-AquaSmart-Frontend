...
const DeleteLotes = ({
    ...
    const confirmDelete = async () => {
        try {
            ...
            await axios.post(
                `${API_URL}/plot-lot/lots/${lots.id_lot}/desactivate`,
                { status: "inactive" },
            ...
            onDeleteSuccess(lots.id_lot);

            // Mostrar mensaje de éxito
            setModalMessage("Lote eliminado correctamente");
            ...
            const errorMessage = error.response?.data?.message ||
                "Error al eliminar el lote. Inténtalo de nuevo más tarde.";
