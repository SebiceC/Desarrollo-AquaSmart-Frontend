    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${API_URL}/caudal/flow-measurements/lote/${id_lot}`, {
                    headers: {
        ...
        fetchData();
    }, [groupByOption, startDate, endDate, dateValidationError, id_lot]);
          ...
          Error al cargar los datos, no existe consumo del lote.
            ...
            <div className="flex-1 py-20">
                <div className="flex flex-col bg-white rounded-lg shadow-md p-6 md:p-10 w-full max-w-4xl mx-auto">
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-center text-gray-800 mb-4">HISTORIAL DE CONSUMO LOTE {id_lot}</h1>
