  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errorData && errorData.status === "error" && errorData.errors) {
        ...
        if (
          errors.document &&
          errors.document.includes("El usuario ya pasó el pre-registro.")
        ) {
          setShowPreRegistroCompletadoModal(true);
        } else if (
          errors.document &&
          errors.document.includes("Ya tienes un pre-registro activo.")
        ) {
          setShowPreRegistroActivoModal(true);
        } else if (
          errors.email &&
          errors.email.includes("Este correo ya está registrado.")
        ) {
