                    ...
                    />
                    {
                        <NavItem
                            ...
                            subItems={[
                                ...
                                hasPermission("ver_predios_distrito") && hasPermission("actualizar_info_predios") && hasPermission("eliminar_info_predios") && { direction: "/gestionDatos/predios", text: "Predios" },
                                hasPermission("view_lot") && hasPermission("delete_lot") && hasPermission("change_lot") && { direction: "/gestionDatos/lotes", text: "Lotes" },
                                hasPermission("view_iotdevice") && hasPermission("change_iotdevice") && hasPermission("delete_iotdevice") && { direction: "/gestionDatos/dispositivosIoT", text: "Dispositvos" },
                            ].filter(Boolean)}
                        />
                    }
                    {
                    ...
                    />
                    {
                        <NavItem
                            ...
                            subItems={[
                                ...
                                hasPermission("ver_historial_consumo_general_distrito") && { direction: "/historial-consumo/distrito", text: "Historial del distrito" },
                            ].filter(Boolean)}
                        />
                    }
