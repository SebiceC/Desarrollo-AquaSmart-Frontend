...
const InputFilterReporteSolicitudes = ({ filters, onFilterChange, onApplyFilters }) => {
  ...
  return (
    <div className="p-4 rounded-lg flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
      ...
      <div className="relative w-full lg:w-[22%] xl:w-1/4">
        ...
        <input
          type="text"
          placeholder="Filtrar por ID de petición"
      ...
      <div className="w-full lg:w-[40%] xl:w-1/3">
        <p className="text-gray-500 text-sm text-center mb-1">Filtrar por periodo de creacion del reporte</p>
...
export default InputFilterReporteSolicitudes;