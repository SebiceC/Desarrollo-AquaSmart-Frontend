...
const DeleteIoT = ({
    ...
    const confirmDelete = async () => {
        try {
            ...
            await axios.patch(
                `${API_URL}/iot/iot-devices/${dispositivo.iot_id}/desactivate`,
                { status: "inactive" },
            ...
            onDeleteSuccess(dispositivo.iot_id);

            // Mostrar mensaje de éxito
            setModalMessage("Dispositivo eliminado correctamente");
            ...
            const errorMessage = error.response?.data?.message ||
                "Error al eliminar el dispositivo. Inténtalo de nuevo más tarde.";
