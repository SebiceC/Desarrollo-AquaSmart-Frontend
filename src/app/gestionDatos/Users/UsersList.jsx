          ...
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo de persona</th>
              ...
              {filteredUsuarios.length === 0 ? (
                ...
                filteredUsuarios.map((user) => (
                  <tr key={user.document} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.document}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {personTypeNames[user.person_type] || "Desconocido"}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
