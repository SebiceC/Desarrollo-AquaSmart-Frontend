...
import BaseInfoFinalModal from "../../../../components/BaseInfoFinalModal";

/**
 * Modal para la asignación de solicitudes de Cancelación Definitiva de Caudal
 */
const CancelacionDefinitivaF = ({ showModal, onClose, solicitudBasica, onSuccess, onError }) => {
  ...
  return (
    <BaseInfoFinalModal
      ...
      onSuccess={onSuccess}
      onError={onError}
      titulo="Cancelación Definitiva de Caudal"
...
export default CancelacionDefinitivaF;